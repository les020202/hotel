...
import com.example.hotelres.owner.BookingDayRepository;
...
public class ReservationService {
    ...
    public HoldRes createHold(CreateHoldReq req) {
        ...
        for (BookingDay d : days) {
            if (!Boolean.TRUE.equals(d.getSellable()) || d.getRemainingQty() < qty) {
        ...
        hold.setCouponCode(couponApplied ? couponCode : null);
