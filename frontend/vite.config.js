...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      /*
      '/api':     { target: 'http://172.16.15.53:8888', changeOrigin: true },
      '/oauth2':  { target: 'http://172.16.15.53:8888', changeOrigin: true },
      '/files':   { target: 'http://172.16.15.53:8888', changeOrigin: true },
      '/confirm': { target: 'http://172.16.15.53:8888', changeOrigin: true },
      '/logout':  { target: 'http://172.16.15.53:8888', changeOrigin: true },
      */
    },
  },
})
