  ...
  routes: [
    ...
    // ✅ 마이페이지 라우트
    {
      ...
      children: [
        ...
        { path: 'payment', component: Payment },   // 결제/카드 관리
        { path: 'support', component: Support }    // 고객지원 진입
      ]
    },
    // ✅ reservation 관련 라우트
{ path: '/reservation', component: ReservationPage, meta: { requiresAuth: true } },
{ path: '/reservation/success', component: PaymentSuccess, meta: { requiresAuth: true } },
{ path: '/reservation/fail', component: PaymentFail, meta: { requiresAuth: true } },
