...
.menu { padding:8px; flex: 0 0 auto; }
.item {
...
.main {
  ...
  display: flex;
  flex-direction: column;
  min-width: 0;         /* ★ flex item이 줄어들 수 있게 */
}
.topbar {
...
.content { flex:1; padding:18px; overflow:auto } /* ★ 콘텐츠는 스크롤 */
.admin-shell {
  display: flex;
  min-height: 100vh;
  width: 100%;
